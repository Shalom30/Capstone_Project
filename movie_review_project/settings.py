...
# SECRET_KEY = 'django-insecure-l#zm94i@rnp+#(l9qhvc@l)691m7-a615c6uc3ybyiczlhpp)r'
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-l#zm94i@rnp+#(l9qhvc@l)691m7-a615c6uc3ybyiczlhpp)r')
